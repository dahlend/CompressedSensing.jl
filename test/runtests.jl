...
IRLS_GuessSignal = IRLS(Measure,[Measure*Signal],threshold=1e-10,maxiter=5000)[1] 
...
UIRLS_GuessSignal=UIRLS(Measure,Measure*Signal+Noise,lambda=.1,maxiter=2000)[1]
